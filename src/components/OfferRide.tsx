...
import { RiderEarningsCalculator } from './RiderEarningsCalculator';
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="relative">
              ...
              <Input type="number" min="0" step="5" placeholder="Enter price" className="pl-10" />
            </div>
            <p className="text-sm text-gray-500">Set a fair price based on distance and fuel costs</p>
            <RiderEarningsCalculator />
          </div>
